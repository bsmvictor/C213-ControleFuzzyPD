...
def control_simulation(error, delta_error, motor_power, BaseRegras):
    setpoint = 1000
...
def main():
    ...
    BaseRegras = create_rules(erro, delta_erro, potencia_motor)
    show_table(erro, delta_erro, potencia_motor, BaseRegras)
    control_simulation(erro, delta_erro, potencia_motor, BaseRegras)
